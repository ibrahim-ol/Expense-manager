...
<!-- Mirrored from wrappixel.com/demos/admin-templates/monster-admin/minisidebar/pages-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Jun 2018 09:56:59 GMT -->
<head>
    <meta charset="utf-8">
...
<!-- ============================================================== -->
<section id="wrapper">
    <div class="login-register" style="background-color:#4e555b;">
            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" method="post" action="{{ route('register') }}">
                    ...
                    <div class="form-group has-danger">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" required autofocus name="name" placeholder="Name" value="{{old('name')}}">
                            @if ($errors->has('name'))
